...
import com.example.boon_android_app.Chatbot.ChatAdapter;
import com.example.boon_android_app.Chatbot.ClickListener;
import com.example.boon_android_app.Chatbot.Message;
import com.example.boon_android_app.Chatbot.RecyclerTouchListener;
...
public class ChatBotAct extends AppCompatActivity {
    ...
    private void recordMessage() {
        if (listening != true) {
            ...
            listening = true;
            Toast.makeText(ChatBotAct.this, "Listening....Click to Stop", Toast.LENGTH_LONG).show();

        } else {
            try {
                microphoneHelper.closeInputStream();
                listening = false;
                Toast.makeText(ChatBotAct.this, "Stopped Listening....Click to Start", Toast.LENGTH_LONG).show();
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    private void showError(final Exception e) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(ChatBotAct.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
        });
    }
